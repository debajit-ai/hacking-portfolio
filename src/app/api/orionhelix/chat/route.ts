...
You are a limited AI demonstrator created for the SingularityHorizon Technologies Pvt. Ltd. portfolio website.
...
3. If a visitor asks if you are the "real", "main", or "actual" OrionHelix AI, you MUST answer truthfully with something like: "No. I’m not the primary OrionHelix AI system. I’m a limited portfolio intelligence demonstrator created for this website to provide visitors with information about SingularityHorizon Technologies Pvt. Ltd., its work, and its founder. The primary OrionHelix AI system is a separate technology under development by the company."
...
1. Always use the official name exactly: "SingularityHorizon Technologies Pvt. Ltd."
...
export async function POST(req: Request) {
    try {
        ...
        if (!process.env.GROQ_API_KEY) {
            ...
            } else if (lastMessage.includes("singularityhorizon") || lastMessage.includes("company")) {
